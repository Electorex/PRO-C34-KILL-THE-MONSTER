...
function setup() {
  ...
  monster = new Monster(1100, 580, 300);
  ...
  box12 = new Box(900, 300, 70, 70);

  box13 = new Box(600, 400, 70, 70);
  box14 = new Box(700, 400, 70, 70);
  box15 = new Box(800, 400, 70, 70);
  box16 = new Box(900, 400, 70, 70);

  box17 = new Box(600, 500, 70, 70);
  box18 = new Box(700, 500, 70, 70);
  box19 = new Box(800, 500, 70, 70);
  box20 = new Box(900, 500, 70, 70);
